...
class NLIRPutField extends NLIRInstruction {
     ...
     * @param value  LIR of the value of the field.
     */
...
class NLIRALoad extends NLIRInstruction {
     ...
     * @param id       identifier of the instruction.
     * @param opcode   JVM opcode for the instruction.
     * @param arrayRef LIR of the array reference.
     * @param index    LIR of the array index.
     * @param sType    type (short name) of the array.
     * @param lType    type (long name) of the array.
     */
...
class NLIRAStore extends NLIRInstruction {
     ...
     * @param arrayRef LIR of the array reference.
     * @param index    LIR of the array index.
     * @param value    LIR of the value to store.
     * @param sType    type (short name) of the array.
     * @param lType    type (long name) of the array.
     */
...
class NLIRPhiFunction extends NLIRInstruction {
     ...
     * @param block enclosing block.
     * @param id    identifier of the instruction.
     * @param sType type (short name) of the phi function.
     * @param lType type (long name) of the phi function.
     */
...
class NLIRLoad extends NLIRInstruction {
     ...
     * @param block      enclosing block.
     * @param id         identifier of the instruction.
     * @param offset     stack offset to load from.
     * @param offsetFrom whether offset relative to stack pointer (sp) or frame pointer
     *                   (fp).
     * @param register   register to load to.
     */
...
class NLIRStore extends NLIRInstruction {
     ...
     * @param block      enclosing block.
     * @param id         identifier of the instruction.
     * @param offset     stack offset to store to.
     * @param offsetFrom whether offset relative to stack pointer (sp) or frame pointer
     *                   (fp).
     * @param register   register to store from.
     */
